...
$appls = mysqli_query($conn,"SELECT * FROM applicants WHERE job_id = $jobid");
...
$_SESSION['currentpage'] = "applicants.php?jobid=$jobid";
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            ...
                            <div class="hero__caption hero__caption2 pt-200">
                                <h1>Applications for <?php echo $jobname ?></h1>
                            </div>	
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-6">
                        ...
                        <div class="popular-directorya-area fix">
                            <div class="row">
                                ...
                                <?php 
                                while($row = mysqli_fetch_assoc($appls))
                                {
                                ?>
                                    ...
                                    <div class="properties properties2 mb-30">
                                        <div class="properties__card">
                                            ...
                                            <div class="properties__caption">
                                                <h3><a href="app_details.php?appid=<?php echo $row['app_id'];?>"><?php echo $row['app_name'];?></a></h3>
                                            </div>
                                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                                <div class="restaurant-name">
                                                    <img src="assets/img/gallery/restaurant-icon.png" alt="">
                                                    <h3>Applied on <?php echo date( 'd/m/Y', strtotime($row['apply_date']));?></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
