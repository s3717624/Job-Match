                            ...
                            <div class="single-top-jobs">
                                <div class="services-cap">
                                    ...
                                    <form id="addjobform" name="addjobform" method="post" action="php/adding_job.php">
                                        ...
                                        <div style="text-align:center;"><input style="margin: auto; width: 550px"
                                                type="text" id="jobname" name="jobname" placeholder="Job name"></div>
                                        <br><br>
                                        <p>Job Location<span style="color: red;"> *</span></p>
                                        <div style="text-align:center;"><input style="margin: auto; width: 550px"
                                                type="text" id="joblocation" name="joblocation"
                                                placeholder="Job location"></div><br><br>
                                        ...
                                        <p>Job Salary</p>
                                        <div style="text-align:center;"><input style="margin: auto; width: 550px"
                                                type="text" id="jobsalary" name="jobsalary" placeholder="Job salary">
                                        </div><br><br>
                                        <p>Job Application Date</p>
                                        <div><input style="margin: auto;" type="date" id="jobapply" name="jobapply">
                                        </div><br><br>
                                        <p>Short Job Description<span style="color: red;"> *</span></p>
                                        <div style="text-align:center;"><textarea id="jobshortdesc" name="jobshortdesc"
                                                rows="5" cols="60" form="addjobform"
                                                placeholder="Short job description"></textarea></div><br><br>
                                        <p>Job Description</p>
                                        <div style="text-align:center;"><textarea id="jobdesc" name="jobdesc" rows="10"
                                                cols="60" form="addjobform" placeholder="Job description"></textarea>
                                        </div><br><br>
                                        <p>Job Skills</p>
                                        <div style="text-align:center;"><textarea id="jobskills" name="jobskills"
                                                rows="5" cols="60" form="addjobform"
                                                placeholder="Skills needed for the job"></textarea></div><br><br>
                                        <p>Job Education</p>
                                        <div style="text-align:center;"><textarea id="jobeducation" name="jobeducation"
                                                rows="5" cols="60" form="addjobform"
                                                placeholder="Education needed for the job"></textarea></div><br><br>
                                        <p style="color: lightblue;">Fields marked with <span
